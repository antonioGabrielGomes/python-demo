...
def findPokerHand(hand):
    ...
    # 5 5 5 6 7 -- set -- 5 6 7 --- unique values = 2 --- three of a kind
    ...
    pokerHandRank = {10:"Royal Flush",9:"Straight Flush",8:"Four of a Kind",7:"Full House",6:"Flush",
...
if __name__ == "__main__":
    ...
    findPokerHand(["10H", "10C", "10D", "2D", "2D"])# Three of a Kind
